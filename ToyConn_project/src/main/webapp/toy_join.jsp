...
<body class="animsition">
	...
	<div class="container">
		<div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg">
			...
			</a> <span class="stext-109 cl4"> 장난감 등록 </span>
		</div>
	</div>
			...
			<div class="flex-w flex-tr">
				<div
					...
					<form action="fileUploadService" name="newProduct" method="post"
							...
							<div class="size-204 respon6-next">
								<div class="rs1-select2 bor8 bg0">
									<input type="file" accept="images/png"
										src="images/image_join.png" name="productImage"
						...
						<div class="flex-w flex-r-m p-b-10 m-b-20">
							<div class="size-203 flex-c-m respon6">가격</div>
						...
						<div class="flex-w flex-r-m p-b-10 m-b-30">
							<div class="size-203 flex-c-m respon6">상세정보</div>
